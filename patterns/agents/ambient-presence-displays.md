...
**Demo:** [aiuxplayground.com/pattern/ambient-presence-displays](https://aiuxplayground.com/pattern/ambient-presence-displays)
...
- Apple Watch Siri orb
- macOS menu bar indicators
- Tesla Autopilot graphics
- Nest Hub ambient mode

## On the site

[Ambient Presence Displays demo](https://aiuxplayground.com/pattern/ambient-presence-displays) · [more agents](https://aiuxplayground.com/patterns/agents)
